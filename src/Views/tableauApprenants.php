...
<div class="tab-content" id="nav-tabContent">
    ...
    <div class="d-flex justify-content-around">
      ...
      <tbody>
        <?php foreach($apprenants as $apprenant) {?>
          ...
          <a  class="supprimerApprenant link-unstyled" data-supprimeAp-id = <?php echo $apprenant->id_utilisateur?>  >Supprimer</a></td>
        </tr>
      </tbody>
      <?php } ?>
    </table>
  ...
  <div class="d-flex justify-content-around">
      ...
      <tbody>
        <?php foreach($apprenantsEnRetard as $apprenantEnRetard) {?>
          <tr >
          ...
          <td> <?php
          if($apprenantEnRetard->mdp == null){echo "non";}
          else{echo "oui";} ?> </td>
          <td class="d-flex justify-content-evenly">
          <a  class="editerApprenant link-unstyled" data-editeApRet-id = <?php echo $apprenantEnRetard->id_utilisateur?> >Editer</a>
          <a  class="supprimerApprenant link-unstyled" data-supprimeApRet-id = <?php echo $apprenantEnRetard->id_utilisateur?>  >Supprimer</a></td>
        </tr>
      </tbody>
      <?php } ?>
    </table>
